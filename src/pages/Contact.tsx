...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Phone, label: "Phone", value: "9443355212", href: "tel:9443355212" },
    { icon: Mail, label: "Email", value: "sakthiprasannarsp@gmail.com", href: "mailto:sakthiprasannarsp@gmail.com" },
    { icon: MapPin, label: "Location", value: "Chetpet, near Tiruvannamalai", href: "https://maps.app.goo.gl/xUdb718oSYZmjo6DA" },
    { icon: Clock, label: "Hours", value: "Mon – Sat, 9AM – 6PM", href: undefined },
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <form onSubmit={handleSubmit} className="glass-panel p-8 sm:p-12 space-y-6">
                <h3 className="font-heading text-2xl text-foreground mb-2">Send a Message</h3>
            ...
            >
              ...
              <div className="gold-border p-2">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3895.8!2d79.3!3d12.4!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDI0JzAwLjAiTiA3OcKwMTgnMDAuMCJF!5e0!3m2!1sen!2sin!4v1"
                  width="100%"
                  height="350"
